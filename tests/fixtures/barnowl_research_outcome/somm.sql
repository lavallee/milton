...
INSERT INTO calls VALUES
    (
        ...
        'fixture-provider-receipt', 'fixture-pricing-v1', 'production', NULL
    ),
    (
    ...
    (
        'fixture-call-unlisted', '2026-07-18T12:00:02+00:00', 'barnowl',
        'fixture_workload', 'fixture-workload:evaluator-v1',
        'fixture-provider-c', 'fixture-model-c', 40, 5, 0.07, 'ok',
        'correlation-retry-1', 'reported', 'marginal', 'actual',
